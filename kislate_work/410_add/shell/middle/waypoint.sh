...
--tab -e 'bash -c "sleep 6; roslaunch rplidar_ros rplidar.launch; exec bash"' \
...
--tab -e 'bash -c "sleep 6; roslaunch px4_command flytwopoints.launch; exec bash"' \
--tab -e 'bash -c "sleep 6; roslaunch usb_cam usb_cam-test.launch; exec bash"' \
--tab -e 'bash -c "sleep 6; source ~/smart_ws/devel/setup.bash; roslaunch darknet_ros darknet_ros.launch; exec bash"' \
