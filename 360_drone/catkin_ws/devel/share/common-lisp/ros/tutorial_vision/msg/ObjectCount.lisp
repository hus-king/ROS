...
(cl:defmethod cl:initialize-instance :after ((m <ObjectCount>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectCount)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorial_vision-msg:<ObjectCount> is deprecated: use tutorial_vision-msg:ObjectCount instead.")))
...
(cl:defmethod count-val ((m <ObjectCount>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_vision-msg:count-val is deprecated.  Use tutorial_vision-msg:count instead.")
  (count m))
