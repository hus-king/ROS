...
"""autogenerated by genpy from tutorial_vision/BoundingBox.msg. Do not edit."""
import codecs
import sys
...
class BoundingBox(genpy.Message):
  _md5sum = "a1d18b873d18165dbbd0a2e39e7e22e0"
  _type = "tutorial_vision/BoundingBox"
...
int64 ymax
string Class"""
  __slots__ = ['probability','xmin','ymin','xmax','ymax','Class']
  _slot_types = ['float64','int64','int64','int64','int64','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       probability,xmin,ymin,xmax,ymax,Class
