...
"""autogenerated by genpy from tutorial_vision/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
class BoundingBoxes(genpy.Message):
  _md5sum = "0c66b76f3c0a60b31a7bca182a3b5d0d"
  _type = "tutorial_vision/BoundingBoxes"
...
string Class"""
  ...
  _slot_types = ['std_msgs/Header','tutorial_vision/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = tutorial_vision.msg.BoundingBox()
        _x = val1
        start = end
        end += 40
