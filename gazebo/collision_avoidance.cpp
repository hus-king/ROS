...
void printf()
{
    ...
    cout << "random_disturbance_x : " << random_disturbance[0] << " [m/s] "<<endl;
    cout << "random_disturbance_y : " << random_disturbance[1] << " [m/s] "<<endl;

    cout << "vel_sp_x_ENU : " << vel_sp_ENU[0] << " [m/s] "<<endl;
    cout << "vel_sp_y_ENU : " << vel_sp_ENU[1] << " [m/s] "<<endl;
}
